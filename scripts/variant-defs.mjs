...
.hero-hint{position:absolute;left:50%;top:calc(100dvh - 76px - 56px - env(safe-area-inset-bottom,0px));z-index:3;translate:-50% 0;display:grid;place-items:center;width:44px;height:44px;color:var(--muted);animation:heroFloat 5s ease-in-out infinite}
